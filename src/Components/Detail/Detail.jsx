    ...
    return (
        <>
            ...
            <div className="container-fluid" style={
                {
                    background: `linear-gradient(transparent 70%, ${(dark ? "rgba(15, 15, 15, 1)" : "rgba(247, 247, 247, 1)")}), url(${game.background_image})`,
                    ...
                    <div className="col-12 col-md-8 ">
                        <div className="row">
                            <div className={"col-12 my-3 " + classes.height28} >
                                <div className={classes.shadow_custom} >
            ...
            {/* Quarta row */}
            <div className={"container-fluid p-0 " + (dark ? 'dark' : 'light')}>
